        ...
        <div className="flex justify-between h-16">
          <div className="flex items-center">
            <Link href="/" className="flex-shrink-0 flex items-center">
              <span className="text-2xl font-bold text-blue-600">PhysioCare</span>
            </Link>
          </div>
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <Link href="/appointment" className="bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-700">
              Book Appointment
            </Link>
          </div>
      ...
      {isMenuOpen && (
        <div className="md:hidden">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            ...
            <Link href="/appointment" className="block px-3 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700">
              Book Appointment
            </Link>
          </div>
        </div>
